                                                ...
                                                RefCountPtr<SyntaxArena> arena)
{
   ...
   RefCountPtr<RawSyntax> target = RawSyntax::make(SyntaxKind::ConditionElementList, layout, SourcePresence::Present,
                                                   arena);
                                          ...
                                          RefCountPtr<SyntaxArena> arena)
{
   ...
   RefCountPtr<RawSyntax> target = RawSyntax::make(SyntaxKind::SwitchCaseList, layout, SourcePresence::Present,
                                                   arena);
                                      ...
                                      RefCountPtr<SyntaxArena> arena)
{
   ...
   RefCountPtr<RawSyntax> target = RawSyntax::make(SyntaxKind::ElseIfList, layout, SourcePresence::Present,
                                                   arena);
...
StmtSyntaxNodeFactory::makeConditionElement(Syntax condition, std::optional<TokenSyntax> trailingComma,
                                            RefCountPtr<SyntaxArena> arena)
{
   RefCountPtr<RawSyntax> target = RawSyntax::make(SyntaxKind::ConditionElement, {
                                                      condition.getRaw(),
...
StmtSyntaxNodeFactory::makeContinueStmt(TokenSyntax continueKeyword, std::optional<TokenSyntax> numberToken,
                                        RefCountPtr<SyntaxArena> arena)
{
   RefCountPtr<RawSyntax> target = RawSyntax::make(SyntaxKind::ContinueStmt, {
...
StmtSyntaxNodeFactory::makeBreakStmt(TokenSyntax breakKeyword, std::optional<TokenSyntax> numberToken,
                                     RefCountPtr<SyntaxArena> arena)
{
   RefCountPtr<RawSyntax> target = RawSyntax::make(SyntaxKind::BreakStmt, {
                                                      breakKeyword.getRaw(),
                                                      numberToken.has_value() ? numberToken->getRaw() : nullptr
                                                   }, SourcePresence::Present, arena);
...
{
   RefCountPtr<RawSyntax> target = RawSyntax::make(SyntaxKind::FallthroughStmt, {
...
{
   RefCountPtr<RawSyntax> target = RawSyntax::make(SyntaxKind::ElseIfClause, {
...
StmtSyntaxNodeFactory::makeIfStmt(std::optional<TokenSyntax> labelName, std::optional<TokenSyntax> labelColon,
                                  ...
                                  RefCountPtr<SyntaxArena> arena)
{
   RefCountPtr<RawSyntax> target = RawSyntax::make(SyntaxKind::IfStmt, {
...
StmtSyntaxNodeFactory::makeWhileStmt(std::optional<TokenSyntax> labelName, std::optional<TokenSyntax> labelColon,
                                     ...
                                     CodeBlockSyntax body, RefCountPtr<SyntaxArena> arena)
{
   RefCountPtr<RawSyntax> target = RawSyntax::make(SyntaxKind::WhileStmt, {
                                                      labelName.has_value() ? labelName->getRaw() : nullptr,
                                                      labelColon.has_value() ? labelColon->getRaw() : nullptr,
                                                      whileKeyword.getRaw(),
                                                      conditions.getRaw(),
...
StmtSyntaxNodeFactory::makeDoWhileStmt(std::optional<TokenSyntax> labelName, std::optional<TokenSyntax> labelColon,
                                       ...
                                       RefCountPtr<SyntaxArena> arena)
{
   RefCountPtr<RawSyntax> target = RawSyntax::make(SyntaxKind::DoWhileStmt, {
                                                      labelName.has_value() ? labelName->getRaw() : nullptr,
                                                      labelColon.has_value() ? labelColon->getRaw() : nullptr,
                                                      doKeyword.getRaw(),
                                                      body.getRaw(),
...
StmtSyntaxNodeFactory::makeSwitchDefaultLabel(TokenSyntax defaultKeyword, TokenSyntax colon,
                                              RefCountPtr<SyntaxArena> arena)
{
   RefCountPtr<RawSyntax> target = RawSyntax::make(SyntaxKind::SwitchDefaultLabel, {
...
StmtSyntaxNodeFactory::makeSwitchCaseLabel(TokenSyntax caseKeyword, ExprSyntax expr, TokenSyntax colon,
                                           RefCountPtr<SyntaxArena> arena)
{
   RefCountPtr<RawSyntax> target = RawSyntax::make(SyntaxKind::SwitchCaseLabel, {
                                                      caseKeyword.getRaw(),
                                                      expr.getRaw(),
                                                      colon.getRaw()
                                                   }, SourcePresence::Present, arena);
...
StmtSyntaxNodeFactory::makeSwitchCase(Syntax label, CodeBlockItemListSyntax statements,
                                      RefCountPtr<SyntaxArena> arena)
{
   RefCountPtr<RawSyntax> target = RawSyntax::make(SyntaxKind::SwitchCase, {
                                                      label.getRaw(),
                                                      statements.getRaw()
                                                   }, SourcePresence::Present, arena);
...
{
   RefCountPtr<RawSyntax> target = RawSyntax::make(SyntaxKind::SwitchStmt, {
                                                      labelName.has_value() ? labelName->getRaw() : nullptr,
                                                      labelColon.has_value() ? labelColon->getRaw() : nullptr,
...
StmtSyntaxNodeFactory::makeDeferStmt(TokenSyntax deferKeyword, CodeBlockSyntax body,
                                     RefCountPtr<SyntaxArena> arena)
{
   RefCountPtr<RawSyntax> target = RawSyntax::make(SyntaxKind::DeferStmt, {
                                                      deferKeyword.getRaw(),
                                                      body.getRaw()
                                                   }, SourcePresence::Present, arena);
...
StmtSyntaxNodeFactory::makeThrowStmt(TokenSyntax throwKeyword, ExprSyntax expr,
                                     RefCountPtr<SyntaxArena> arena)
{
   RefCountPtr<RawSyntax> target = RawSyntax::make(SyntaxKind::ThrowStmt, {
                                                      throwKeyword.getRaw(),
                                                      expr.getRaw()
                                                   }, SourcePresence::Present, arena);
...
{
   RefCountPtr<RawSyntax> target = RawSyntax::make(SyntaxKind::ConditionElementList, {},
                                                   SourcePresence::Present, arena);
   return make<ConditionElementListSyntax>(target);
}
...
{
   RefCountPtr<RawSyntax> target = RawSyntax::make(SyntaxKind::SwitchCaseList, {},
                                                   SourcePresence::Present, arena);
   return make<SwitchCaseListSyntax>(target);
}
...
{
   RefCountPtr<RawSyntax> target = RawSyntax::make(SyntaxKind::ElseIfList, {}, SourcePresence::Present, arena);
   return make<ElseIfListSyntax>(target);
}
