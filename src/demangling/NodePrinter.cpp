...
private:
   ...
   bool isSimpleType(NodePointer Node) {
      switch (Node->getKind()) {
         ...
         case Node::Kind::PILBoxTypeWithLayout:
         ...
         case Node::Kind::InterfaceList:
            return Node->getChild(0)->getNumChildren() <= 1;

         case Node::Kind::InterfaceListWithAnyObject:
            return Node->getChild(0)->getChild(0)->getNumChildren() == 0;

         case Node::Kind::InterfaceListWithClass:
         ...
         case Node::Kind::GenericInterfaceWitnessTable:
         case Node::Kind::GenericInterfaceWitnessTableInstantiationFunction:
         ...
         case Node::Kind::LazyInterfaceWitnessTableAccessor:
         case Node::Kind::LazyInterfaceWitnessTableCacheVariable:
         ...
         case Node::Kind::InterfaceConformance:
         case Node::Kind::InterfaceConformanceDescriptor:
         case Node::Kind::InterfaceDescriptor:
         case Node::Kind::InterfaceRequirementsBaseDescriptor:
         case Node::Kind::InterfaceSelfConformanceDescriptor:
         case Node::Kind::InterfaceSelfConformanceWitness:
         case Node::Kind::InterfaceSelfConformanceWitnessTable:
         case Node::Kind::InterfaceWitness:
         case Node::Kind::InterfaceWitnessTable:
         case Node::Kind::InterfaceWitnessTableAccessor:
         case Node::Kind::InterfaceWitnessTablePattern:
         ...
         case Node::Kind::PILBoxLayout:
         case Node::Kind::PILBoxMutableField:
         case Node::Kind::PILBoxImmutableField:
...
#include "polarphp/ast/ReferenceStorageDef.h"
         ...
         case Node::Kind::ResilientInterfaceWitnessTable:
         ...
         case Node::Kind::AnyInterfaceConformanceList:
         ...
         case Node::Kind::InterfaceConformanceRefInTypeModule:
         case Node::Kind::InterfaceConformanceRefInInterfaceModule:
         case Node::Kind::InterfaceConformanceRefInOtherModule:
   ...
   void printBoundGeneric(NodePointer Node) {
      ...
      // type.
      if (Node->getKind() == Node::Kind::BoundGenericInterface) {
...
static bool isExistentialType(NodePointer node) {
   return (node->getKind() == Node::Kind::ExistentialMetatype ||
           node->getKind() == Node::Kind::InterfaceList ||
           node->getKind() == Node::Kind::InterfaceListWithClass ||
           node->getKind() == Node::Kind::InterfaceListWithAnyObject);
}
...
#include "polarphp/ast/ReferenceStorageDef.h"
      ...
      case Node::Kind::FunctionSignatureSpecializationParamKind: {
         ...
         if (raw &
            ...
            Printer << "Existential To Interface Constrained Generic";
         }
      ...
      case Node::Kind::InterfaceConformance: {
         ...
         if (Node->getNumChildren() == 4) {
            ...
            print(child0);
            if (Options.DisplayInterfaceConformances) {
               Printer << " : ";
               print(child1);
               Printer << " in ";
               print(child2);
      ...
      case Node::Kind::PILBoxTypeWithLayout: {
         ...
         assert(layout->getKind() == Node::Kind::PILBoxLayout);
      ...
      case Node::Kind::PILBoxImmutableField:
      case Node::Kind::PILBoxMutableField:
         Printer << (Node->getKind() == Node::Kind::PILBoxImmutableField
                     ? "let "
                     : "var ");
