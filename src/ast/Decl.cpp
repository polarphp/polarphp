...
//      if (!ctx.isPolarVersionAtLeast(5)) {
...
//          var->getAstContext().isPolarVersionAtLeast(5))
//         return false;
...
//      if (auto protocol = dyn_cast<InterfaceDecl>(this)) {
//         SmallString<32> scratch;
//         return makeSelector(
...
//      auto proto = cast<InterfaceDecl>(requirement->getDeclContext());
...
//findInterfaceSelfReferences(const InterfaceDecl *proto, Type type,
//                            bool skipAssocTypes) {
//   // Tuples preserve variance.
//   if (auto tuple = type->getAs<TupleType>()) {
//      auto kind = SelfReferenceKind::None();
//      for (auto &elt : tuple->getElements()) {
//         kind |= findInterfaceSelfReferences(proto, elt.getType(), skipAssocTypes);
//      }
//      return kind;
//   }
...
//         if (param.isInOut()) {
//            if (findInterfaceSelfReferences(proto, param.getPlainType(),
//                                            skipAssocTypes)) {
//               return SelfReferenceKind::Other();
//            }
//         }
//         inputKind |= findInterfaceSelfReferences(proto, param.getParameterType(),
//                                                  skipAssocTypes);
//      }
//      auto resultKind = findInterfaceSelfReferences(proto, funcTy->getResult(),
//                                                    skipAssocTypes);
...
//      return findInterfaceSelfReferences(proto, metaTy->getInstanceType(),
//                                         skipAssocTypes);
//   }

//   // Optionals preserve variance.
//   if (auto optType = type->getOptionalObjectType()) {
//      return findInterfaceSelfReferences(proto, optType,
//                                         skipAssocTypes);
//   }
...
//      return findInterfaceSelfReferences(proto, selfType->getSelfType(),
//                                         skipAssocTypes);
//   }
...
//         if (findInterfaceSelfReferences(proto, paramType,
//                                         skipAssocTypes)) {
//            return SelfReferenceKind::Other();
//         }
//      }
...
//static SelfReferenceKind
//findInterfaceSelfReferences(const InterfaceDecl *protocol,
...
//            // inout parameters are invariant.
//            if (param.isInOut()) {
//               if (::findInterfaceSelfReferences(this, param.getPlainType(),
//                                                 skipAssocTypes)) {
//                  return SelfReferenceKind::Other();
//               }
//            }
//            inputKind |= ::findInterfaceSelfReferences(this, param.getParameterType(),
//                                                       skipAssocTypes);
//         }
...
//      if (func->isGeneric()) {
//         if (auto result =
//               ::findInterfaceSelfReferences(this, func->getGenericSignature()))
//            return result;
//      }

//      return ::findInterfaceSelfReferences(this, type,
//                                           skipAssocTypes);
//   } else if (auto subscript = dyn_cast<SubscriptDecl>(value)) {
//      // Check the requirements of a generic subscript.
//      if (subscript->isGeneric()) {
//         if (auto result =
//               ::findInterfaceSelfReferences(this,
...
//                                           skipAssocTypes);
//   } else {
//      if (::findInterfaceSelfReferences(this, type,
//                                        skipAssocTypes)) {
//         return SelfReferenceKind::Other();
//      }
//      return SelfReferenceKind::None();
...
//#include "polarphp/ast/KnownInterfaces.def"
//               .Default(1);
...
//         if (NTD->isResilient() ||
//             (containingModule->getAstContext().isPolarVersionAtLeast(5) &&
