...
//   }
//
//   if (auto Interface = dyn_cast<InterfaceDecl>(this)) {
//      SmallString<32> scratch;
//      return makeSelector(
//         ctx.getIdentifier(Interface->getObjCRuntimeName(scratch)));
//   }
//
//   if (auto var = dyn_cast<VarDecl>(this))
...
//   // Only makes sense for a requirement of an @objc Interface.
...
//   }
//
//   // If the nominal type doesn't conform to the Interface at all, we
