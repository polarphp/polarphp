...
bool IntrinsicInfo::hasAttribute(llvm::Attribute::AttrKind Kind) const {
   ...
   if (DenseMapInfo::isEqual(Attrs, DenseMapInfo::getEmptyKey())) {
      ...
      Attrs = llvm::Intrinsic::getAttributes(get_global_llvm_context(), ID);
   }
...
Type getBuiltinType(AstContext &Context, StringRef Name) {
   ...
   if (Name == "SILToken")
      return Context.ThePILTokenType;
   ...
   if (Name == "AnyObject")
      return CanType(
         InterfaceCompositionType::get(Context, {},
...
static ValueDecl *getCastOperation(AstContext &Context, Identifier Id,
   ...
   switch (VK) {
      default:
         llvm_unreachable("Not a cast operation");
...
llvm::Intrinsic::ID getLLVMIntrinsicID(StringRef InName) {
...
getSwiftFunctionTypeForIntrinsic(llvm::Intrinsic::ID ID,
   ...
   llvm::AttributeList attrs =
      llvm::Intrinsic::getAttributes(get_global_llvm_context(), ID);
...
ValueDecl *getBuiltinValueDecl(AstContext &Context, Identifier Id) {
