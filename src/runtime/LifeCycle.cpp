...
bool php_module_startup(zend_module_entry *additionalModules, uint32_t numAdditionalModules)
{
   ...
   /* Register constants */
   REGISTER_MAIN_STRINGL_CONSTANT("POLARPHP_VERSION", const_cast<char *>(POLAR_VERSION), sizeof(POLAR_VERSION)-1, CONST_PERSISTENT | CONST_CS);
   ...
   REGISTER_MAIN_STRINGL_CONSTANT("POLARPHP_VERSION_SUFFIX", const_cast<char *>(POLAR_VERSION_SUFFIX), sizeof(POLAR_VERSION_SUFFIX) - 1, CONST_PERSISTENT | CONST_CS);
   ...
   REGISTER_MAIN_STRINGL_CONSTANT("POLARPHP_OS", const_cast<char *>(phpOs), strlen(phpOs), CONST_PERSISTENT | CONST_CS);
