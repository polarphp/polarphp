...
# assuming that `short.php` can be successfully executed within 2
# seconds of wallclock time.

# Test per test timeout using external shell
# RUN: not %{phplit} \
# RUN: %{inputs}/shtest-timeout/infinite_loop.php \
# RUN: %{inputs}/shtest-timeout/short.php \
...
# CHECK-INTSH-OUT: TIMEOUT: per_test_timeout :: infinite_loop.php
...
# CHECK-OUT-COMMON: TIMEOUT: per_test_timeout :: infinite_loop.php
# CHECK-OUT-COMMON: Timeout: Reached timeout of 2 seconds
# CHECK-OUT-COMMON: Command {{([0-9]+ )?}}Output

# CHECK-OUT-COMMON: PASS: per_test_timeout :: short.php
...
# CHECK-CMDLINE-OVERRIDE-OUT: TIMEOUT: per_test_timeout :: infinite_loop.php
# CHECK-CMDLINE-OVERRIDE-OUT: Timeout: Reached timeout of 2 seconds
# CHECK-CMDLINE-OVERRIDE-OUT: Command {{([0-9]+ )?}}Output

# CHECK-CMDLINE-OVERRIDE-OUT: PASS: per_test_timeout :: short.php
