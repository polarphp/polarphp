...
#ifndef POLARPHP_FRONTEND_SERIALIZEDDIAGNOSTICCONSUMER_H
#define POLARPHP_FRONTEND_SERIALIZEDDIAGNOSTICCONSUMER_H
...
#endif // POLARPHP_FRONTEND_SERIALIZEDDIAGNOSTICCONSUMER_H
