...
public:
   ...
   /// InterfaceConformanceRef if it does conform.
   InterfaceConformanceRef lookupConformance(Type type, InterfaceDecl *protocol);

   /// Look for the conformance of the given existential type to the given
   /// protocol.
   InterfaceConformanceRef lookupExistentialConformance(Type type,
                                                        InterfaceDecl *protocol);

   /// Exposes TypeChecker functionality for querying protocol conformance.
   /// Returns a valid InterfaceConformanceRef only if all conditional
   /// requirements are successfully resolved.
   InterfaceConformanceRef conformsToInterface(Type sourceTy,
...
private:
   ...
   void operator delete(void *Data) noexcept POLAR_DELETE_OPERATOR_DELETED;
