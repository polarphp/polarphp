...
#ifndef POLARPHP_AST_TYPE_MATCHER_H
#define POLARPHP_AST_TYPE_MATCHER_H
...
#define TRIVIAL_CASE(TheType)                                              \
    ...
    TRIVIAL_CASE(PILFunctionType)
    TRIVIAL_CASE(PILBlockStorageType)
    TRIVIAL_CASE(PILBoxType)
    TRIVIAL_CASE(InterfaceCompositionType)
