...
#ifndef POLARPHP_AST_CLANG_POLARPHP_TYPE_CORRESPONDENCE_H
#define POLARPHP_AST_CLANG_POLARPHP_TYPE_CORRESPONDENCE_H
...
#endif /* POLARPHP_AST_CLANG_POLARPHP_TYPE_CORRESPONDENCE_H */
