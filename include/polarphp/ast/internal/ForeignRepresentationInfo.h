...
#ifndef POLARPHP_AST_INTERNAL_FOREIGN_REPRESENTATIONINFO_H
#define POLARPHP_AST_INTERNAL_FOREIGN_REPRESENTATIONINFO_H
...
public:
  ...
  forBridged(InterfaceConformance *conformance) {
  ...
  InterfaceConformance *getConformance() const {
    ...
    case ForeignRepresentableKind::Bridged: {
      ...
      return static_cast<InterfaceConformance *>(payload);
    }
