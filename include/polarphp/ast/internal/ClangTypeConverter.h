...
#ifndef POLARPHP_AST_INTERNAL_CLANG_TYPE_CONVERTER_H
#define POLARPHP_AST_INTERNAL_CLANG_TYPE_CONVERTER_H
...
private:
   ...
   clang::QualType visitInterfaceType(InterfaceType *type);
   ...
   clang::QualType visitInterfaceCompositionType(InterfaceCompositionType *type);
   ...
   clang::QualType visitPILFunctionType(PILFunctionType *type);
   ...
   clang::QualType visitPILBlockStorageType(PILBlockStorageType *type);
