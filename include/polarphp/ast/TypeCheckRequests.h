...
#include "polarphp/ast/TypeResolutionStage.h"
...
class InterfaceRequiresClassRequest :
    public SimpleRequest<InterfaceRequiresClassRequest,
                         bool(InterfaceDecl *),
                         CacheKind::SeparatelyCached> {
public:
  using SimpleRequest::SimpleRequest;
...
private:
  ...
  // Evaluation.
  llvm::Expected<bool> evaluate(Evaluator &evaluator, InterfaceDecl *decl) const;
...
class RequirementSignatureRequest :
    public SimpleRequest<RequirementSignatureRequest,
                         ArrayRef<Requirement>(InterfaceDecl *),
                         CacheKind::SeparatelyCached> {
public:
  using SimpleRequest::SimpleRequest;
...
void simple_display(llvm::raw_ostream &out, const KnownInterfaceKind);
class TypeChecker;

// Find the type in the cache or look it up
class DefaultTypeRequest
    : public SimpleRequest<DefaultTypeRequest,
                           Type(KnownInterfaceKind, const DeclContext *),
                           CacheKind::SeparatelyCached> {
public:
  using SimpleRequest::SimpleRequest;
...
private:
  ...
  // Evaluation.
  llvm::Expected<Type> evaluate(Evaluator &eval, KnownInterfaceKind,
...
private:
  ...
  evaluate(Evaluator &evaluator, NormalInterfaceConformance *conformance,
...
/// inherited protocols.
class HasCircularInheritedInterfacesRequest
    : public SimpleRequest<HasCircularInheritedInterfacesRequest,
                           bool(InterfaceDecl *), CacheKind::Cached> {
public:
  using SimpleRequest::SimpleRequest;
