...
#ifndef POLARPHP_AST_SIMPLEREQUEST_H
#define POLARPHP_AST_SIMPLEREQUEST_H
...
{
   using internal::extractNearestSourceLoc;
...
#endif // POLARPHP_BASIC_SIMPLEREQUEST_H
