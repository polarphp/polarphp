...
#ifndef POLARPHP_AST_LAZYRESOLVER_H
#define POLARPHP_AST_LAZYRESOLVER_H
...
class LazyInterfaceData : public LazyIterableDeclContextData {
public:
  /// The context data used for loading all of the members of the iterable
  /// context.
...
public:
  ...
  loadAllConformances(const Decl *D, uint64_t contextData,
                      SmallVectorImpl<InterfaceConformance *> &Conformances) = 0;
  ...
  virtual void
  loadRequirementSignature(const InterfaceDecl *proto, uint64_t contextData,
...
public:
  ...
  virtual void
  finishNormalConformance(NormalInterfaceConformance *conformance,
                          uint64_t contextData) = 0;
};

}

#endif // POLARPHP_AST_LAZYRESOLVER_H
