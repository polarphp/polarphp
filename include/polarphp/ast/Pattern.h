...
#ifndef POLARPHP_AST_PATTERN_H
#define POLARPHP_AST_PATTERN_H
...
enum : unsigned { NumPatternKindBits =
                  count_bits_used(static_cast<unsigned>(PatternKind::Last_Pattern)) };
...
class alignas(8) Pattern {
   ...
   union { uint64_t OpaqueBits;
           ...
           POLAR_INLINE_BITFIELD_BASE(Pattern, bitmax(NumPatternKindBits,8)+1+1,
                                      Kind : bitmax(NumPatternKindBits,8),
                                      isImplicit : 1,
                                      hasInterfaceType : 1
                                      );

                POLAR_INLINE_BITFIELD_FULL(TuplePattern, Pattern, 32,
                                           : NumPadBits,
                                           NumElements : 32
                                           );

                     POLAR_INLINE_BITFIELD(TypedPattern, Pattern, 1,
                                           IsPropagatedType : 1
                                           );

                          POLAR_INLINE_BITFIELD(BoolPattern, Pattern, 1,
                                                Value : 1
                                                );

                               POLAR_INLINE_BITFIELD(VarPattern, Pattern, 1,
