...
#ifndef POLARPHP_SEMA_INTERNAL_DERIVEDCONFORMANCES_H
#define POLARPHP_SEMA_INTERNAL_DERIVEDCONFORMANCES_H
...
public:
   ...
   DerivedConformance(AstContext &ctx, Decl *conformanceDecl,
                      NominalTypeDecl *nominal, InterfaceDecl *protocol);
   ...
   /// given protocol.
   static bool derivesInterfaceConformance(DeclContext *DC,
                                          NominalTypeDecl *nominal,
...
#endif // POLARPHP_SEMA_INTERNAL_DERIVEDCONFORMANCES_H
