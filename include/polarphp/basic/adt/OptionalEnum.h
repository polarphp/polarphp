...
#ifndef POLARPHP_BASIC_ADT_OPTIONAL_ENUM_H
#define POLARPHP_BASIC_ADT_OPTIONAL_ENUM_H
...
using polar::utils::IsTriviallyCopyable;
...
public:
   ...
   /// Construct an empty instance.
   /*implicit*/ OptionalEnum(std::nullptr_t)
      : OptionalEnum()
   {}
   ...
   {
      assert(m_storage == (storage_type)(intptr_t)m_storage);
      return (intptr_t)m_storage;
   }
};
} // polar::basic

#endif // POLARPHP_BASIC_ADT_OPTIONAL_ENUM_H
