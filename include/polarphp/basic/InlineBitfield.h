...
#ifndef  POLARPHP_BASIC_INLINE_BITFIELD_H
#define  POLARPHP_BASIC_INLINE_BITFIELD_H
...
/// POLAR_INLINE_BITFIELD(Foo, Bar, 1+3+7+2, w:1, x:3, y:7, z:2);
...
#define POLAR_INLINE_BITFIELD_BASE(T, C, ...) \
  POLAR_PACKED_START \
  class T##Bitfield { \
    friend class T; \
...
#define POLAR_INLINE_BITFIELD_TEMPLATE(T, U, C, HC, ...) \
  POLAR_PACKED_START \
  class T##Bitfield { \
    friend class T; \
...
#define POLAR_INLINE_BITFIELD(T, U, C, ...) \
  POLAR_INLINE_BITFIELD_TEMPLATE(T, U, C, 0, __VA_ARGS__)
...
///
/// POLAR_INLINE_BITFIELD_FULL(Foo, Bar, 1+8+16,
///   flag : 1,
///   : NumPadBits, // pad the center, not the end
///   x : 8,
///   y : 16
/// );
#define POLAR_INLINE_BITFIELD_FULL(T, U, C, ...) \
  POLAR_PACKED_START \
  class T##Bitfield { \
    friend class T; \
...
#define POLAR_INLINE_BITFIELD_EMPTY(T, U) \
...
constexpr unsigned count_bits_used(uint64_t arg)
{
