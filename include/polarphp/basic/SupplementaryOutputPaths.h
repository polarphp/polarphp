...
#ifndef POLARPHP_FRONTEND_SUPPLEMENTARYOUTPUTPATHS_H
#define POLARPHP_FRONTEND_SUPPLEMENTARYOUTPUTPATHS_H
...
//   std::string ObjCHeaderOutputPath;
  ...
  /// These files are consumed by the Swift driver (or will be someday) to
   ...
   ///
   /// \sa swift::emitPolarphpRanges
   std::string PHPRangesFilePath;
...
#endif // POLARPHP_FRONTEND_SUPPLEMENTARYOUTPUTPATHS_H
