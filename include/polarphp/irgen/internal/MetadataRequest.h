...
#ifndef POLARPHP_IRGEN_INTERNAL_METADATAREQUEST_H
#define POLARPHP_IRGEN_INTERNAL_METADATAREQUEST_H
...
/// it.
llvm::Value *emitTypeLayoutRef(IRGenFunction &IGF, PILType type,
                               MetadataDependencyCollector *collector);
...
#endif // POLARPHP_IRGEN_INTERNAL_METADATAREQUEST_H
