...
#ifndef POLARPHP_IRGEN_INTERNAL_LEGACY_LAYOUT_FORMAT_H
#define POLARPHP_IRGEN_INTERNAL_LEGACY_LAYOUT_FORMAT_H
...
template <> struct MappingTraits<polar::irgen::YAMLTypeInfoNode> {
  static void mapping(IO &io, polar::irgen::YAMLTypeInfoNode &node) {
...
template <> struct MappingTraits<polar::irgen::YAMLModuleNode> {
  static void mapping(IO &io, polar::irgen::YAMLModuleNode &node) {
    io.mapRequired("Name", node.Name);
...
LLVM_YAML_IS_SEQUENCE_VECTOR(polar::irgen::YAMLTypeInfoNode)
LLVM_YAML_IS_DOCUMENT_LIST_VECTOR(polar::irgen::YAMLModuleNode)

#endif // POLARPHP_IRGEN_INTERNAL_LEGACY_LAYOUT_FORMAT_H
