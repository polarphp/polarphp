...
#ifndef POLARPHP_SERIALIZATION_MODULELOADER_H
#define POLARPHP_SERIALIZATION_MODULELOADER_H
...
/// Imports serialized Polarphp modules into an AstContext.
class SerializedModuleLoader : public SerializedModuleLoaderBase {
   ...
   SerializedModuleLoader(AstContext &ctx, DependencyTracker *tracker,
                          ModuleLoadingMode loadMode, bool IgnorePolarphpSourceInfo)
      : SerializedModuleLoaderBase(ctx, tracker, loadMode, IgnorePolarphpSourceInfo)
   {}
...
public:
   ...
   create(AstContext &ctx, DependencyTracker *tracker = nullptr,
          ...
          bool IgnorePolarphpSourceInfo = false) {
      return std::unique_ptr<SerializedModuleLoader>{
         new SerializedModuleLoader(ctx, tracker, loadMode, IgnorePolarphpSourceInfo)
      };
   }
};
...
class MemoryBufferSerializedModuleLoader : public SerializedModuleLoaderBase {
   ...
   MemoryBufferSerializedModuleLoader(AstContext &ctx,
                                      ...
                                      ModuleLoadingMode loadMode,
                                      bool IgnorePolarphpSourceInfo)
      : SerializedModuleLoaderBase(ctx, tracker, loadMode,
                                   IgnorePolarphpSourceInfo) {}
