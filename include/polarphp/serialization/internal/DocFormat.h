...
#ifndef POLARPHP_SERIALIZATION_DOCFORMAT_H
#define POLARPHP_SERIALIZATION_DOCFORMAT_H

namespace polar {
namespace serialization {

/// Magic number for serialized documentation files.
const unsigned char PHPDOC_SIGNATURE[] = { 0xE2, 0x9C, 0xA8, 0x07 };
...
const uint16_t PHPDOC_VERSION_MINOR = 1; // Last change: skipping 0 for testing purposes
...
const uint32_t PHPDOC_HASH_SEED_5_1 = 0;
