...
#ifndef POLARPHP_INTERNAL_FRONTENDTOOL_REFERENCEDEPENDENCIES_H
#define POLARPHP_INTERNAL_FRONTENDTOOL_REFERENCEDEPENDENCIES_H
...
/// Emit a php-style dependencies file for \p SF.
