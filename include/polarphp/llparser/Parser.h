...
////===----------------------------------------------------------------------===//
//
//#ifndef POLARPHP_LLPARSER_PARSER_H
//#define POLARPHP_LLPARSER_PARSER_H
//
...
//#include "polarphp/llparser/ParserResult.h"
////#include "polarphp/llparser/SyntaxParserResult.h"
...
////using polar::ast::DefaultArgumentInitializer;
////using polar::ast::TupleType;
////using polar::ast::TypeLoc;
////using polar::ast::EnumElementInfo;
////using polar::ast::SourceFile;
////using polar::ast::DeclContext;
////using polar::ast::AstContext;
////using polar::ast::ParamDecl;
////using polar::ast::VarDecl;
////using polar::ast::Decl;
////using polar::ast::DiagnosticTransaction;
////using polar::ast::TopLevelCodeDecl;
////using polar::ast::ParameterList;
////using polar::ast::BraceStmt;
////using polar::ast::AstNode;
////using polar::ast::TypeDecl;
////using polar::ast::DeclAttributes;
////using polar::ast::TypeDecl;
////using polar::ast::IfConfigDecl;
...
//   SourceFile &SF;
//   Lexer *L;
//   PILParserTUStateBase *PIL; // Non-null when parsing a .sil file.
...
//          PILParserTUStateBase *PIL,
//          PersistentParserState *PersistentState,
//          /* std::shared_ptr<SyntaxParseActions> SPActions = nullptr, */
//          bool DelayBodyParsing = true);
//   Parser(unsigned BufferID, SourceFile &SF, PILParserTUStateBase *PIL,
//          PersistentParserState *PersistentState = nullptr,
//          /* std::shared_ptr<SyntaxParseActions> SPActions = nullptr, */
//          bool DelayBodyParsing = true);
//   Parser(std::unique_ptr<Lexer> Lex, SourceFile &SF,
//          PILParserTUStateBase *PIL = nullptr,
//          PersistentParserState *PersistentState = nullptr,
//          /* std::shared_ptr<SyntaxParseActions> SPActions = nullptr,*/
//          bool DelayBodyParsing = true);
//   ~Parser();
//
//   bool isInPILMode() const { return PIL != nullptr; }
//
...
//          isInPILMode() || L->isSwiftInterface())
//         return;
//
...
//                                          size_t Len = 1);
//
//   ScopeInfo &getScopeInfo() { return State->getScopeInfo(); }
//
...
//   bool parseSpecializeAttribute(tok ClosingBrace, SourceLoc AtLoc,
...
//   ParserResult<InterfaceDecl> parseDeclInterface(ParseDeclOptions Flags,
//                                                DeclAttributes &Attributes);
//
...
//   ParserResult<TypeRepr> parseOldStyleInterfaceComposition();
//   ParserResult<TypeRepr> parseAnyType();
//   ParserResult<TypeRepr> parsePILBoxType(GenericParamList *generics,
...
//   bool canParseOldStyleInterfaceComposition();
...
//
//   ParserStatus
//   parseInterfaceOrAssociatedTypeWhereClause(TrailingWhereClause *&trailingWhere,
//                                            bool isInterface);
//
//   //===--------------------------------------------------------------------===//
