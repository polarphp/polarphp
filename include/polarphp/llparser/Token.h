...
#ifndef POLARPHP_LLPARSER_TOKEN_H
#define POLARPHP_LLPARSER_TOKEN_H

#include "polarphp/basic/SourceLoc.h"
#include "polarphp/basic/LLVM.h"
#include "polarphp/llparser/TokenKinds.h"
...
} // end namespace polar::llaprser


namespace llvm {
  template <typename T> struct isPodLike;
  template <>
  struct isPodLike<polar::llparser::Token> { static const bool value = true; };
} // end namespace llvm
