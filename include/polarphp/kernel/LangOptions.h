...
//
// Copyright (c) 2014 - 2018 Apple Inc. and the Polarphp project authors
...
#include "polarphp/ast/PlatformConditionKindsDef.h"
};
...
public:
  ...
  /// On Darwin platforms, use the pre-stable ABI's mark bit for Polarphp
  ...
  /// it gets disabled when compiling the Polarphp core stdlib.
  ...
  /// errors when deserializing from a Polarphp module.
  ///
  ...
  bool EnablePILOpaqueValues = false;

  /// If set to true, the diagnosis engine can assume the emitted diagnostics
  /// will be used in editor. This usually leads to more aggressive fixit.
  bool DiagnosticsEditorMode = false;

  /// Whether to enable Polarphp 3 @objc inference, e.g., for members of
  /// Objective-C-derived classes and 'dynamic' members.
  bool EnablePolarphp3ObjCInference = false;
  ...
  /// check for isPolarphpVersionAtLeast(5).
  ...
  /// contribute to a Polarphp Bridging PCH hash.
