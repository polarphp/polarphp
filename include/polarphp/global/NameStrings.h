...
constexpr static const StringLiteral STDLIB_NAME = "Polarphp";
/// The name of the Onone support library, which is a reserved module name.
constexpr static const StringLiteral POLAR_ONONE_SUPPORT = "PolarOnoneSupport";
/// The name of the SwiftShims module, which contains private stdlib decls.
constexpr static const StringLiteral POLAR_SHIMS_NAME = "PolarShims";
