...
#ifndef POLARPHP_PIL_OPTIMIZATIONREMARKEMITTER_H
#define POLARPHP_PIL_OPTIMIZATIONREMARKEMITTER_H
...
struct Argument {
  ...
  Argument(StringRef Key, PILFunction *F);
  Argument(StringRef Key, PILType Ty);
...
protected:
  Remark(StringRef Identifier, PILInstruction &I)
...
struct RemarkPassed : public Remark<RemarkPassed> {
  RemarkPassed(StringRef Id, PILInstruction &I) : Remark(Id, I) {}
};
/// Remark to report a unsuccessful optimization.
struct RemarkMissed : public Remark<RemarkMissed> {
  RemarkMissed(StringRef Id, PILInstruction &I) : Remark(Id, I) {}
};
...
public:
  Emitter(StringRef PassName, PILModule &M);
