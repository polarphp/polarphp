...
inline bool is_possibly_used_externally(PILLinkage linkage, bool wholeModule)
{
   if (wholeModule) {
...
PILLinkage get_decl_pil_linkage(const ValueDecl *decl);

inline bool has_public_visibility(PILLinkage linkage)
{
   switch (linkage) {
   case PILLinkage::Public:
   case PILLinkage::PublicExternal:
...
inline bool has_shared_visibility(PILLinkage linkage)
{
   switch (linkage) {
   case PILLinkage::Shared:
   case PILLinkage::SharedExternal:
...
inline bool has_private_visibility(PILLinkage linkage)
{
   switch (linkage) {
   case PILLinkage::Private:
   case PILLinkage::PrivateExternal:
...
inline PILLinkage effective_linkage_for_class_member(PILLinkage linkage, SubclassScope scope)
{
   switch (scope) {
...
inline bool
fixme_witness_has_linkage_that_needs_to_be_public(PILLinkage witnessLinkage)
{
   return !has_public_visibility(witnessLinkage) &&
         !has_shared_visibility(witnessLinkage);
}
