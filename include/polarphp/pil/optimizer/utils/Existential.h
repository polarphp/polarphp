...
#ifndef POLARPHP_PIL_OPTIMIZER_UTILS_EXISTENTIAL_H
#define POLARPHP_PIL_OPTIMIZER_UTILS_EXISTENTIAL_H
...
// ConcreteExistentialInfo from the same PILValue.
