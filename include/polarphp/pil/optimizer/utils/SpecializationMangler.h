...
#ifndef POLARPHP_PIL_OPTIMIZER_UTILS_SPECIALIZATIONMANGLER_H
#define POLARPHP_PIL_OPTIMIZER_UTILS_SPECIALIZATIONMANGLER_H
...
protected:
  ...
  PILFunction *getFunction() const { return Function; }
...
public:
  GenericSpecializationMangler(PILFunction *F, SubstitutionMap SubMap,
...
class PartialSpecializationMangler : public SpecializationMangler {
  ...
  CanPILFunctionType SpecializedFnTy;
  bool isReAbstracted;

public:
  PartialSpecializationMangler(PILFunction *F,
                               CanPILFunctionType SpecializedFnTy,
                               IsSerialized_t Serialized, bool isReAbstracted)
      : SpecializationMangler(SpecializationPass::GenericSpecializer,
                              Serialized, F),
...
class FunctionSignatureSpecializationMangler : public SpecializationMangler {
  ...
  // Information for each PIL argument in the original function before
  // specialization. This includes PIL indirect result argument required for
...
private:
  ...
  void mangleClosureProp(PILInstruction *Inst);
...
} // end namespace polar::mangle

#endif // POLARPHP_PIL_OPTIMIZER_UTILS_SPECIALIZATIONMANGLER_H
