...
#ifndef POLARPHP_RUNTIME_ATOMIC_H
#define POLARPHP_RUNTIME_ATOMIC_H
...
#  define POLAR_MEMORY_ORDER_CONSUME (std::memory_order_relaxed)
#else
#  define POLAR_MEMORY_ORDER_CONSUME (std::memory_order_consume)
#endif
