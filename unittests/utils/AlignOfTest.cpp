...
using polar::utils::AlignedCharArray;
...
struct POLAR_ALIGNAS(1) A1 {};
struct POLAR_ALIGNAS(2) A2 {};
struct POLAR_ALIGNAS(4) A4 {};
struct POLAR_ALIGNAS(8) A8 {};
...
struct S6 { POLAR_ATTRIBUTE_UNUSED double f(); };
struct D1 : S1 {};
struct D2 : S6 { POLAR_ATTRIBUTE_UNUSED float g(); };
struct D3 : S2 {};
struct D4 : S2 { int x; };
struct D5 : S3 { char c; };
struct D6 : S2, S3 {};
...
TEST(AlignOfTest, testBasicAlignedArray)
{
