...
using polar::utils::DataExtractor;
...
TEST(DataExtractorTest, testSignedNumbers) {
   DataExtractor DE(StringRef(numberData, sizeof(numberData)-1), false, 8);
   uint32_t offset = 0;
...
TEST(DataExtractorTest, testStrings)
{
...
TEST(DataExtractorTest, testLEB128)
{
