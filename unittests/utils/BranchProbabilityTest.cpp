...
TEST(BranchProbabilityTest, testAccessors)
{
...
TEST(BranchProbabilityTest, testOperators)
{
...
TEST(BranchProbabilityTest, testMoreOperators)
{
   BP A(4, 5);
   BP B(4U << 29, 5U << 29);
   BP C(3, 4);
...
TEST(BranchProbabilityTest, testArithmeticOperators)
{
   BP Z(0, 1);
   BP O(1, 1);
   BP H(1, 2);
...
TEST(BranchProbabilityTest, testScale)
{
   // Multiply by 1.0.
...
TEST(BranchProbabilityTest, testScaleByInverse)
{
   // Divide by 1.0.
...
TEST(BranchProbabilityTest, testScaleBruteForce)
{
   struct {
      uint64_t Num;
      uint32_t Prob[2];
...
TEST(BranchProbabilityTest, testNormalizeProbabilities)
{
