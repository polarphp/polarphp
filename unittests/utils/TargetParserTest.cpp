...
//                            arm::AEK_DSP, "6"));
//   EXPECT_TRUE(test_arm_cpu("arm1176j-s", "armv6k", "none",
//                            arm::AEK_DSP, "6K"));
...
//   EXPECT_TRUE(
//            test_arm_arch("armv6k", "arm1176j-s", "v6k",
...
//   EXPECT_FALSE(test_arm_extension("generic", arm::ArchKind::ARMV8_2A, "spe"));
...
//TEST(TargetParserTest, ARMparse_archVersion)
//{
//   for (unsigned i = 0; i < array_lengthof(ARMArch); i++)
...
//   unsigned FPUKind = aarch64::get_default_fpu(CPUName, AK);
//   pass &= aarch64::get_fpu_name(FPUKind).equals(ExpectedFPU);
...
//TEST(TargetParserTest, test_aarch64_archFeatures)
//{
//   std::vector<StringRef> Features;
...
//TEST(TargetParserTest, test_aarch64_archExtFeature)
//{
//   const char *ArchExt[][4] = {{"crc", "nocrc", "+crc", "-crc"},
//                               {"crypto", "nocrypto", "+crypto", "-crypto"},
