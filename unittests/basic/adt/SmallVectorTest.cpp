...
TYPED_TEST(SmallVectorTest, testResizeWithElements)
{
   this->theVector.resize(2);
...
// Swap test.
TYPED_TEST(SmallVectorTest, testSwap)
{
...
TYPED_TEST(SmallVectorTest, testAppendRepeated)
{
...
// Append test
TYPED_TEST(SmallVectorTest, testAppendNonIter)
{
...
// Assign test
TYPED_TEST(SmallVectorTest, testAssignRange)
{
   SCOPED_TRACE("AssignTest");
...
// Assign test
TYPED_TEST(SmallVectorTest, testAssignNonIter)
{
   SCOPED_TRACE("AssignTest");
...
// Move-assign test
TYPED_TEST(SmallVectorTest, testMoveAssign)
{
...
TYPED_TEST(SmallVectorTest, testInsertRepeated)
{
...
TYPED_TEST(SmallVectorTest, testInsertRepeatedNonIter)
{
   SCOPED_TRACE("InsertRepeatedTest");
...
TYPED_TEST(SmallVectorTest, testInsertRepeatedAtEnd)
{
   SCOPED_TRACE("InsertRepeatedTest");
...
TYPED_TEST(SmallVectorTest, testInsertRepeatedEmpty)
{
   SCOPED_TRACE("InsertRepeatedTest");
...
TYPED_TEST(SmallVectorTest, testInsertRangeAtEnd)
{
   SCOPED_TRACE("InsertRangeTest");
...
TYPED_TEST(SmallVectorTest, testInsertEmptyRange)
{
   SCOPED_TRACE("InsertRangeTest");
...
// Comparison tests.
TYPED_TEST(SmallVectorTest, testComparison)
{
...
TYPED_TEST(SmallVectorTest, testConstVector)
{
...
// Direct array access.
TYPED_TEST(SmallVectorTest, testDirectVector)
{
...
TYPED_TEST(SmallVectorTest, testIterator)
{
   std::list<int> L;
