...
#include "polarphp/basic/adt/SparseMultiSet.h"
...
// Empty set tests.
TEST(SparseMultiSetTest, testEmptySet)
{
   USet Set;
...
TEST(SparseMultiSetTest, testSingleEntrySet)
{
   USet Set;
   Set.setUniverse(10);
...
TEST(SparseMultiSetTest, testMultipleEntrySet)
{
   USet Set;
   Set.setUniverse(10);
...
// Test out iterators
TEST(SparseMultiSetTest, testIterators)
{
   USet Set;
   Set.setUniverse(100);
   ...
   USet::RangePair RangePair = Set.equalRange(0);
...
TEST(SparseMultiSetTest, testAltStructSet)
{
