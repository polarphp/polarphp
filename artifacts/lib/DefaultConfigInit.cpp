...
///
/// TODO remove short open tags support
///
...
POLAR_STD_INI_ENTRY("arg_separator.output",	"&",		POLAR_INI_ALL,		update_string_unempty_handler,	argSeparator.output,	ExecEnvInfo,	sg_execEnvInfo)
POLAR_STD_INI_ENTRY("arg_separator.input",	"&",		POLAR_INI_SYSTEM|POLAR_INI_PERDIR,	update_string_unempty_handler,	argSeparator.input,	ExecEnvInfo,	sg_execEnvInfo)
