...
//
// Created by polarboy on 2018/12/21.
...
POLAR_INI_MH(update_bool_handler)
{
   zend_bool *p;
...
POLAR_INI_MH(update_long_handler)
{
   zend_long *p;
   char *base = (char *) mh_arg2;
...
POLAR_INI_MH(update_long_ge_zero_handler)
{
   zend_long *p, tmp;
   char *base = (char *) mh_arg2;
...
POLAR_INI_MH(update_real_handler)
{
   double *p;
   char *base;
...
POLAR_INI_MH(update_string_handler)
{
   std::string *p;
   char *base = (char *) mh_arg2;
...
POLAR_INI_MH(update_string_unempty_handler)
{
   std::string *p;
   char *base = (char *) mh_arg2;
