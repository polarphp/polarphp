...
function(polar_windows_arch_spelling arch var)
...
function(polar_windows_include_for_arch arch var)
  set(paths
...
function(polar_windows_lib_for_arch arch var)
  polar_windows_arch_spelling(${arch} ARCH)
...
function(polar_windows_generate_sdk_vfs_overlay flags)
...
function(polar_verify_windows_VCVAR var)
  if (NOT DEFINED "${var}" AND NOT DEFINED "ENV{${var}}")
    message(FATAL_ERROR "${var} environment variable must be set")
  endif()
endfunction()

function(polar_windows_cache_VCVARS)
  polar_verify_windows_VCVAR(VCToolsInstallDir)
  polar_verify_windows_VCVAR(UniversalCRTSdkDir)
  polar_verify_windows_VCVAR(UCRTVersion)
...
macro(polar_swap_compiler_if_needed target)
